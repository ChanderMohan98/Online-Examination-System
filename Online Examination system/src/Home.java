...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(242, 241, 0));
...
Login1 rpf=new Login1();   //create new object of the window you want to open
        ...
        this.dispose();   //closes the current window        // TODO add your handling code here:
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
Login rpf=new Login();   //create new object of the window you want to open
        rpf.setVisible(true);   //makes it visible
        rpf.pack();
        rpf.setLocationRelativeTo(null);   //sets the location relative to current  component
        rpf.setDefaultCloseOperation(EXIT_ON_CLOSE);
